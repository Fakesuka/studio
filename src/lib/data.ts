...
export const mockShops: Shop[] = [
    { id: 'shop-1', name: 'Авто-Мир', type: 'store', address: 'г. Якутск, ул. Чернышевского, 66', workingHours: 'Пн-Вс: 9:00 - 20:00', imageUrl: findImage('shop-1').imageUrl, imageHint: findImage('shop-1').imageHint, bannerUrl: findImage('shop-1-banner').imageUrl, bannerHint: findImage('shop-1-banner').imageHint, description: 'Все для вашего авто. Качественные запчасти и аксессуары.' },
    { id: 'shop-2', name: 'Все для авто', type: 'store', address: 'г. Якутск, ул. Автодорожная, 11/4', workingHours: 'Пн-Пт: 10:00 - 19:00', imageUrl: findImage('shop-2').imageUrl, imageHint: findImage('shop-2').imageHint, bannerUrl: findImage('shop-2-banner').imageUrl, bannerHint: findImage('shop-2-banner').imageHint, description: 'Широкий ассортимент автотоваров по доступным ценам.' },
    { id: 'shop-3', name: 'Шинный двор', type: 'person', imageUrl: findImage('shop-3').imageUrl, imageHint: findImage('shop-3').imageHint, bannerUrl: findImage('shop-3-banner').imageUrl, bannerHint: findImage('shop-3-banner').imageHint, description: 'Шины и диски от ведущих производителей. Частный продавец.' },
    { id: 'shop-4', name: 'Ремонт-Профи', type: 'store', address: 'г. Якутск, ул. 50 лет Советской Армии, 33', workingHours: 'Круглосуточно', imageUrl: findImage('shop-4').imageUrl, imageHint: findImage('shop-4').imageHint, bannerUrl: findImage('shop-4-banner').imageUrl, bannerHint: findImage('shop-4-banner').imageHint, description: 'Инструменты и расходники для профессионального ремонта.' },
    { id: 'shop-5', name: 'Запчасти-Экспресс', type: 'person', imageUrl: findImage('shop-5').imageUrl, imageHint: findImage('shop-5').imageHint, bannerUrl: findImage('shop-5-banner').imageUrl, bannerHint: findImage('shop-5-banner').imageHint, description: 'Быстрая доставка оригинальных и аналоговых запчастей от частного лица.' },
    { id: 'shop-6', name: 'Японские запчасти', type: 'store', address: 'г. Якутск, ул. Пояркова, 20', workingHours: 'Пн-Сб: 9:00 - 18:00', imageUrl: findImage('shop-1').imageUrl, imageHint: findImage('shop-1').imageHint, bannerUrl: findImage('shop-1-banner').imageUrl, bannerHint: findImage('shop-1-banner').imageHint, description: 'Все для японских автомобилей: от фильтров до двигателей.' },
];
